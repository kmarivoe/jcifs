 ...
 */
public class NtTransSetSecurityDesc extends SmbComNtTransaction
{
    ...
    // possible security info values. See http://msdn.microsoft.com/en-us/library/ee441668.aspx for more context
    public static final int OWNER_SECURITY_INFORMATION = 0x01;
    public static final int GROUP_SECURITY_INFORMATION = 0x02;
    public static final int DACL_SECURITY_INFORMATION = 0x04;
    public static final int SACL_SECURITY_INFORMATION = 0x08;
    ...
    NtTransSetSecurityDesc(int fid, int securityInformation, SecurityDescriptor securityDescriptor)
    {
        this.fid = fid;
    ...
    int writeDataWireFormat(byte[] dst, int dstIndex)
    {
        ...
        for (ACE ace : securityDescriptor.getAces()) {
        ...
        writeInt4(securityDescriptor.getAces().length, dst, dstIndex);
        dstIndex += 4;

        for (ACE ace : securityDescriptor.getAces()) {
            dstIndex += ace.encode(dst, dstIndex);
        }

...
import jcifs.dcerpc.msrpc.MsrpcShareSetInfo;
...
/* URLConnection implementation */
    ...
    public ACE[] getSecurity(boolean resolveSids) throws IOException
    {
        ...
        aces = response.securityDescriptor.getAces();
        if (aces != null)
    ...
    public void setShareSecurity(ACE[] aces) throws IOException {
        ...
        try {
            ...
            SecurityDescriptor sd = new SecurityDescriptor(aces);
    ...
    /**
     * Sets the specified ACEs on the file
     */
    public int setSecurity(ACE[] aces) throws IOException
    {
        int f;
        ...
        NtTransSetSecurityDesc request = new NtTransSetSecurityDesc(f, NtTransSetSecurityDesc.DACL_SECURITY_INFORMATION, sd);
